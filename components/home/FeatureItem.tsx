...
const FeatureItem: React.FC<Props> = ({ heading, points, imageSide, imageSrc = unloadedImg }) => {
  ...
  return (
    <ScrollViewContainer>
      ...
      >
        <FeatureItemImage src={imageSrc} altTextName={heading} className="w-1/2" />
        <div className="w-1/2">
      ...
      <div className="flex flex-col lg:hidden">
        ...
        <FeatureItemImage src={imageSrc} altTextName={heading} className="mb-2" />
        <div>
          <ul className="list-disc flex flex-col gap-1">
            {points.map((point, index) => (
              <li className="ml-4" key={index}>
